...
.controller('loginCtrl', function($scope,$http,$ionicPopup,$state,$ionicHistory) {
		...
		$scope.login = function() {
			str="http://192.168.43.120/foodkart/user-details.php?e="+$scope.user.email+"&p="+$scope.user.password;
			$http.get(str)
...
.controller('signupCtrl', function($scope,$http,$ionicPopup,$state,$ionicHistory) {
	...
	$scope.signup=function(data){
			...
			var link = 'http://192.168.43.120/foodkart/signup.php';
...
.controller('pprofileCtrl', function($scope,$rootScope,$ionicHistory,$state) {
